...
1. Download `Ripen.exe` and `RipenInit.exe` from [GitHub Releases](https://github.com/ayato-labs/ripen/releases).
...
1. [GitHub Releases](https://github.com/ayato-labs/ripen/releases) から `Ripen.exe` および `RipenInit.exe` をダウンロードします。
2. **初期セットアップ（必須）**: 
